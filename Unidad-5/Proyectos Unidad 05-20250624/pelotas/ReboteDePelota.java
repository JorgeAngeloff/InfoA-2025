 ...
 * por la misma pelota. Cae hacia abajo acelrandose por el efecto gravitatorio,
 * y rebota hacia arriba cuando golpea el piso.
 *
 * Este movimiento puede ser iniciado repetidamente llamando al mtodo "mover"
 * 
 * @author Bruce Quig
...
public class ReboteDePelota
{
     ...
     * @param posPiso  la posicin del piso (donde la pelota rebotar)
