...
/* Informatica Avanzada - 2021 */
    ...
    public String getDescripcionLarga()
    {
        ...
        String descripcionLarga = getDescripcionCorta() + "\n";
        if(derramado != null)
        {
            descripcionLarga += "Se ha derramado " + derramado + "\n";
        }
        descripcionLarga += getStringDeSalidas() + "\n" + getStringDeElementos();
     ...
     private class ConElementos extends EstadoContenedor {
        ...
        public void addElemento(Elemento elemento) throws ContenedorLlenoException, AccionNoPermitidaException
         ...
         public Elemento getElemento(String nombre) throws ContenedorVacioException, AccionNoPermitidaException
         {
             ...
             Elemento elementoASacar = elementos.get(nombre);
             if(elementoASacar instanceof NoPortable)
             {
         ...
         public String toString()
         {
             String elementosEnHabitacion = "Elementos:";
             for(String elemento : elementos.keySet())
             {
                 elementosEnHabitacion += " " + elemento;
             }
             return elementosEnHabitacion;
         }
    }
