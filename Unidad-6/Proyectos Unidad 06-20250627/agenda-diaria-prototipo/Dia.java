...
public class Dia
{
    ...
    // El nmero de horas posible de un da.
    public static final int MAX_CITAS_POR_DIA =
                                ULTIMA_HORA -
                                PRIMER_HORA + 1;
    
    // Un nmero de da de un ao en particular. (1-366)
    private int diaNumero;
    // La lista actual de citas de un da.
    private Cita[] citas;

    /**
     * Constructor de objetos de la clase Dia.
     * @param diaNumero El nmero de este da en el ao(1-366).
     */
     ...
     * @return La hora ms temprana en que se puede ubicar la cita
    ...
    /**
     * @param hora A qu hora del da. Debe ser una hora comprendida entre
     *        PRIMER_HORA y  ULTIMA_HORA.
     * @return La Cita a la hora dada. Devuelve null si la hora no es vlida
    ...
    /**
     * Imprime la lista de las citas del da
     */
